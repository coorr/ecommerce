...
import kr.ecommerce.domain.support.response.ErrorsResponse;
import kr.ecommerce.domain.support.error.NotFoundException;
import kr.ecommerce.domain.support.error.SimpleMessageIllegalArgumentException;
import kr.ecommerce.domain.support.error.SimpleMessageIllegalStateException;
import kr.ecommerce.domain.support.error.ValidationIllegalArgumentException;
